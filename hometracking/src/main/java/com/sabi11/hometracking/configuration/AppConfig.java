...
// Tell to Spring this is configuration file
//@Configuration
//// Tell to Spring which properties file and location
//@PropertySource("classpath:db.properties")
//// enable the transaction
//@EnableTransactionManagement
//// Tell to Spring which packages need to be scanned
...
//        props.put(
//                DRIVER,
//                environment.getProperty("mysql.driver"));
//        props.put(
//                URL,
